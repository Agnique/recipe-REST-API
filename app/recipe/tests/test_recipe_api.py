...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_create_recipe_with_ingredients(self):
        ...
        ingredient1 = sample_ingredient(user=self.user, name='Powder')
    ...
    def test_filter_recipes_by_tags(self):
        ...
        recipe2 = sample_recipe(user=self.user, title='pork dumpling')
        tag1 = sample_tag(user=self.user, name='Vegan')
        tag2 = sample_tag(user=self.user, name='Traditional')
    ...
    def test_filter_recipes_by_ingredients(self):
        ...
        recipe1 = sample_recipe(user=self.user, title='Whatever')
        recipe2 = sample_recipe(user=self.user, title='Strawberry Yogurt')
        ingredient1 = sample_ingredient(user=self.user, name='cheese')
        ingredient2 = sample_ingredient(user=self.user, name='Chicken')
        recipe1.ingredients.add(ingredient1)
        recipe2.ingredients.add(ingredient2)
        recipe3 = sample_recipe(user=self.user, title='nothing')
